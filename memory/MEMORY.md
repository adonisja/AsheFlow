...
- [AP Sort migration](project_apsort_migration.md) — TruckSortPanel moving from Sort.tsx → WalkerSort.tsx; RouteCard/RouteRow merge deferred with full context for follow-up
